<template>
  <div class="ui main container">
    ...
    <button @click="navigateTo('/')" class="ui huge green left button" type="submit">
      ポジティブな投稿を見てみる
    </button>
    ...
    <div class="ui segment">
      <div class="ui two column grid">
        ...
        <div class="left-fields">
          ...
          <!-- 投稿日時とリンク -->
          <div class="field">
            <p>投稿日時: <span class="date">2024-08-08<a href="https://example.com" target="_blank" class="ui blue button">メンテナンスのお知らせ</a></span></p>
            <p>投稿日時: <span class="date">2024-07-15<a href="https://example.com" target="_blank" class="ui blue button">メンテナンスのお知らせ</a></span></p>
            <p>投稿日時: <span class="date">2024-05-02<a href="https://example.com" target="_blank" class="ui blue button">アプリリリースのお知らせ</a></span></p>
          </div>
        </div>
        </div>
